...
3. **Verificar antes de avançar:** ao concluir uma tarefa, faça uma checagem de
   consistência (ex: reabrir o arquivo gerado, checar dimensões da matriz, conferir
   se o dado bate com a fonte oficial) antes de marcá-la como `completed`. Se a
   verificação falhar, corrija antes de seguir — não acumule erros entre etapas.
